...
WebUI.click(findTestObject('Page_Login Admin/form_Email                                 _01a518'))

WebUI.click(findTestObject('Page_Login Admin/input_Email_email'))
...
if ('halaman_tujuan' == 'http://localhost/tokobuah/index.php/admin/login') {

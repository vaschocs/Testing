...
WebUI.navigateToUrl('http://localhost/tokobuah/index.php/admin')
...
WebUI.setText(findTestObject('Page_Tokobuah Admin - Products/textarea_Description_description'), 'buah pisang segar yang dipetik langsung dari pohonnya')

WebUI.setText(findTestObject('Page_Tokobuah Admin - Products/input_Price_price'), '25000000000')

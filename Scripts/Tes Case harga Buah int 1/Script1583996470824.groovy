...
WebUI.setText(findTestObject('Page_Tokobuah Admin - Products/input_Name_name'), 'Pisang Lagi')

WebUI.setText(findTestObject('Page_Tokobuah Admin - Products/input_Price_price'), '250000000000')

WebUI.setText(findTestObject('Page_Tokobuah Admin - Products/textarea_Description_description'), 'ini pisang tapi bohong, beli item satunya aja')
